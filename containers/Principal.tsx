    ...
    <>
      ...
      <Modal show ={showModal} onHide={closeModal} className="container-modal">
        <Modal.Body>
          ...
          <input type="text" placeholder="Data de previsão da tarefa" value={previsionDate} onChange={e => setPrevisionDate(e.target.value)} onBlur={e => e.target.type = "text"} onFocus={e => e.target.type = "date"} />
        </Modal.Body>
        <Modal.Footer>
